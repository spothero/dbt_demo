...
SELECT
      ...
      ,SUM(avg_stalls_available) as est_p1w_avg_weekend_morning_stalls_available
      ,SUM(min_stalls_available) as est_p1w_min_weekend_morning_stalls_available
FROM z
WHERE uninterrupted_hours >= 6
GROUP BY 1