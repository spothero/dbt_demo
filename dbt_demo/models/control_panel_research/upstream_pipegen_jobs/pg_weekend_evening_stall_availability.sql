  with z as (
          ...
          SELECT
                ...
                ,SUM(avg_stalls_available) as est_p1w_avg_weekend_evening_stalls_available
                ,SUM(min_stalls_available) as est_p1w_min_weekend_evening_stalls_available
          FROM z
          WHERE uninterrupted_hours >= 5
          GROUP BY 1