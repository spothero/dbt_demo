...
WHERE ((((accounting_export_line.effective_date ) >= ((DATEADD(month,-1, DATE_TRUNC('month', DATE_TRUNC('day',CONVERT_TIMEZONE('UTC', 'America/Chicago', GETDATE()))) ))) AND (accounting_export_line.effective_date ) < ((DATEADD(month,2, DATEADD(month,-1, DATE_TRUNC('month', DATE_TRUNC('day',CONVERT_TIMEZONE('UTC', 'America/Chicago', GETDATE()))) ) )))))) AND (parking_spot.parking_spot_id  IN (2840,1406,12247,2191,2189,2916,2187,2186,8006,8010,1886,14354,1879,1893,1877,1881,5873,10283,1887,7289,2993,14443,11607,13838,6111,11858,7946,7995)) AND (NOT accounting_export_line._fivetran_deleted OR accounting_export_line._fivetran_deleted IS NULL)
...
WHERE ((((accounting_export_line.effective_date ) >= ((DATEADD(month,-1, DATE_TRUNC('month', DATE_TRUNC('day',CONVERT_TIMEZONE('UTC', 'America/Chicago', GETDATE()))) ))) AND (accounting_export_line.effective_date ) < ((DATEADD(month,2, DATEADD(month,-1, DATE_TRUNC('month', DATE_TRUNC('day',CONVERT_TIMEZONE('UTC', 'America/Chicago', GETDATE()))) ) )))))) AND (parking_spot.parking_spot_id  IN (2840,1406,12247,2191,2189,2916,2187,2186,8006,8010,1886,14354,1879,1893,1877,1881,5873,10283,1887,7289,2993,14443,11607,13838,6111,11858,7946,7995)) AND (NOT accounting_export_line._fivetran_deleted OR accounting_export_line._fivetran_deleted IS NULL)
GROUP BY DATE_TRUNC('month', accounting_export_line.effective_date ),2
ORDER BY 1 ,2 DESC
LIMIT 50